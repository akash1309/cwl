  ...
  render() {
    return (
      <div style={{ width: '280px', backgroundColor: '#f7f1e3', padding: '20px' , height : '100%'}}>
        ...
        <a onClick={this.props.onClickUploadIC} style={styles.innerContainerStyle}>
          <MaterialIcon.MdReceipt size={styles.iconSize} style={styles.iconStyle}/>
          <span style={styles.textStyle}>Upload IC</span>
        </a>
        <div style={styles.dividerStyle}/>

        <a onClick={this.props.onClickUploadCorrigendum} style={styles.innerContainerStyle}>
          <MaterialIcon.MdDescription size={styles.iconSize} style={styles.iconStyle}/>
          <span style={styles.textStyle}>Upload Corrigendum</span>
        </a>
        <div style={styles.dividerStyle}/>

        <a onClick={this.props.onClickUploadRejectionLetter} style={styles.innerContainerStyle}>
          <MaterialIcon.MdAssignment size={styles.iconSize} style={styles.iconStyle}/>
          <span style={styles.textStyle}>Upload Rejection Letter</span>
        </a>
        <div style={styles.dividerStyle}/>
