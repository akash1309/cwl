...
var StoreOfficerPalette = function (_Component) {
  _inherits(StoreOfficerPalette, _Component);

  function StoreOfficerPalette(props) {
    _classCallCheck(this, StoreOfficerPalette);

    return _possibleConstructorReturn(this, (StoreOfficerPalette.__proto__ || Object.getPrototypeOf(StoreOfficerPalette)).call(this, props));
  }

  _createClass(StoreOfficerPalette, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { onClick: this.props.onClickPlacePurchaseOrder, style: styles.innerContainerStyle },
          _react2.default.createElement(MaterialIcon.MdAddShoppingCart, { size: styles.iconSize, style: styles.iconStyle }),
          _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement(
          'a',
          { onClick: this.props.onClickAddVendor, style: styles.innerContainerStyle },
  ...
  return StoreOfficerPalette;
}(_react.Component);

exports.default = StoreOfficerPalette;
